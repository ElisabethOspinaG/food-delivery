...
const AvatarUpload = ({ setAvatar, imageUrl }) => {
    ...
    const handleBeforeUpload = async (file) => {
        ...
        formData.append('upload_preset', 'subirarchivos'); //AQUI PONES LA CLAVE subir archivo

        try {
            const response = await axios.post(
                'https://api.cloudinary.com/v1_1/dar9uwn3r/image/upload',
                formData,
                {
                    headers: {
    ...
    return (
        <>
            <Upload
                name="file"
                action=  'https://api.cloudinary.com/v1_1/dar9uwn3r/image/upload'
